var domain_url = "//localhost/project/plugin/";
...
for (var i = 0; i < gw_img.length; i++) {
	if (gw_img[i].getAttribute("alt")
			&& !gw_img[i].getAttribute("gw_originalWidth")) {
...
bodyhtml+="<input type='hidden' id='windowlocation' value='"+window.location.href+"'/>";
